		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="logouturl">Logout</a></li>
					<li class="nav-item mx-0 mx-lg-1 bg-danger" id="uname"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#"><%=session.getAttribute("username")
					%></a></li>
